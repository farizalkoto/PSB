...
@section('lulus','m-menu__item--active')
				...
				<div class="m-portlet__head-caption">
					<div class="m-portlet__head-title">
						...
						<h3 class="m-portlet__head-text">
							Kirim pesan kepada siswa yang lulus
						</h3>
					</div>
				</div>
			</div>
			<form action="{{ url('pesan/lulus') }}" method="post" class="m-form m-form--state m-form--fit m-form--label-align-right" id="form">
  			{{ csrf_field() }}
