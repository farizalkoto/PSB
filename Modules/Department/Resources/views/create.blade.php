    ...
    <div class="row">
      <div class="col-xl-12">
		<div class="m-portlet">
			...
			<form action="{{ url('jurusan/create') }}" method="post" class="m-form m-form--state m-form--fit m-form--label-align-right" id="form">
  			{{ csrf_field() }}
				<div class="m-portlet__body">
					<div class="m-form__section m-form__section--first">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-lg-6">
								<input type="number" name="department_max" value="{{ old('department_max') }}" class="form-control m-input" placeholder="Input kuota jurusan" maxlength="100" autofocus required>
							</div>
						</div>
						<div class="form-group m-form__group row">
							<label class="col-lg-3 col-form-label">
							...
							<div class="col-lg-6">
								<textarea name="desc" class="form-control m-input" required>{{ old('desc') }}</textarea>
							</div>
						</div>
					</div>
				</div>
