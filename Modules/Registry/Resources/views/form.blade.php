@extends('layouts.student.template')
            ...
            <div class="m-portlet__body">
                ...
                <div class="col-lg-12">
                    ...
                    @if (isset($list['result']['studentPersonal']['studentUploads'][1]['student_upload_url']))
                        <div class="col-lg-4">
                            <img class="ez img-thumbnail" src="/{{ $list['result']['studentPersonal']['studentUploads'][1]['student_upload_url'] }}"  alt="{{ $list['result']['studentPersonal']['studentUploads'][0]['student_upload_name'] }}" style="width:100%;max-width:300px">
                        </div>
                    @endif
                    @if (isset($list['result']['studentPersonal']['studentUploads'][2]['student_upload_url']))
                        <div class="col-lg-4">
                            <img class="ez img-thumbnail" src="/{{ $list['result']['studentPersonal']['studentUploads'][2]['student_upload_url'] }}" alt="{{ $list['result']['studentPersonal']['studentUploads'][0]['student_upload_name'] }}" style="width:100%;max-width:300px">
                        </div>
                    @endif
                </div></div></div>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.ez', function () {
            $('#myModal').modal('show');
            var ez = $('.ez');
            $('.modal-title').text(ez.attr('alt'));
            $('.imgmy').attr('src',ez.attr('src'));
        });
    </script>
@stop
