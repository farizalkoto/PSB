...
class RegistryServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = resource_path('views/modules/registry');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/registry';
        }, \Config::get('view.paths')), [$sourcePath]), 'registry');
    }
    ...
    {
        $langPath = resource_path('lang/modules/registry');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'registry');
        } else {
